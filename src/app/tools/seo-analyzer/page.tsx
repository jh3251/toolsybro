...
export const metadata: Metadata = {
  title: 'SEO Analyzer | Free Website Audit Tool (Coming Soon) | ToolsyBro',
  description: 'Get a free SEO audit for your website. This feature is coming soon to our collection of 100% free tools.',
};
