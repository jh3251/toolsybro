    ...
    <div className="flex flex-col space-y-16">
      <section className="text-center">
        ...
        <p className="mx-auto mt-6 max-w-[700px] text-muted-foreground md:text-xl">
          A comprehensive collection of utilities to boost your productivity. Simple, powerful, and always free.
        </p>
      </section>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {category.tools.map((tool) => (
              <Link href={tool.href} key={tool.name} className="group">
                <Card className="h-full border-2 border-transparent transition-all duration-300 hover:border-primary hover:shadow-2xl hover:-translate-y-1">
