...
export const toolCategories: ToolCategory[] = [
  {
    ...
    icon: BookText,
    tools: [
      { name: 'Word Counter', description: 'Count words in your text with our free tools.', href: '/tools/word-counter', icon: Calculator },
      { name: 'Character Counter', description: 'Count characters in your text with our free tools.', href: '/tools/character-counter', icon: Type },
      { name: 'Sentence Counter', description: 'Count sentences in your text with our free tools.', href: '/tools/sentence-counter', icon: ListTree },
      { name: 'Paragraph Counter', description: 'Count paragraphs in your text with our free tools.', href: '/tools/paragraph-counter', icon: ListOrdered },
      { name: 'Text Case Converter', description: 'Convert text to different cases with our free tools.', href: '/tools/text-case-converter', icon: CaseUpper },
      { name: 'Remove Duplicate Lines', description: 'Remove duplicate lines from text with our free tools.', href: '/tools/remove-duplicate-lines', icon: Eraser },
      { name: 'Text Sorter (A–Z / Z–A)', description: 'Sort text lines alphabetically with our free tools.', href: '/tools/text-sorter', icon: Shuffle },
      { name: 'Find & Replace Text', description: 'Find and replace text with our free tools.', href: '/tools/find-replace-text', icon: Replace },
      { name: 'Text to Speech', description: 'Convert text to speech with our free tools.', href: '/tools/text-to-speech', icon: AudioLines },
      { name: 'Speech to Text', description: 'Convert speech to text with our free tools.', href: '/tools/speech-to-text', icon: Mic },
    ],
  },
  {
    name: 'Image Tools',
    icon: FileImage,
    tools: [
      { name: 'Image Compressor', description: 'Compress image file sizes with our free tools.', href: '/tools/image-compressor', icon: Image },
      { name: 'Image Resizer', description: 'Resize image dimensions with our free tools.', href: '/tools/image-resizer', icon: Crop },
      { name: 'Image Cropper', description: 'Crop images to a specific area with our free tools.', href: '/tools/image-cropper', icon: Scissors },
      { name: 'Image Converter', description: 'Convert between PNG, JPG, WEBP with our free tools.', href: '/tools/image-converter', icon: ArrowRightLeft },
      { name: 'Image to Base64', description: 'Encode images to Base64 with our free tools.', href: '/tools/image-to-base64', icon: FileCode },
      { name: 'Base64 to Image', description: 'Decode Base64 to an image with our free tools.', href: '/tools/base64-to-image', icon: FileImage },
      { name: 'Image Watermark Tool', description: 'Add watermarks to images with our free tools.', href: '/tools/image-watermark', icon: PenTool },
      { name: 'Image Background Remover', description: 'Remove backgrounds from images with our free tools.', href: '/tools/image-background-remover', icon: Eraser },
      { name: 'Image Metadata Viewer', description: 'View image EXIF data with our free tools.', href: '/tools/image-metadata-viewer', icon: FileJson },
      { name: 'Image Color Picker', description: 'Pick colors from an image with our free tools.', href: '/tools/image-color-picker', icon: Droplet },
    ],
  },
  {
    name: 'PDF Tools',
    icon: FileText,
    tools: [
        { name: 'PDF to JPG', description: 'Convert PDF pages to JPG images with our free tools.', href: '/tools/pdf-to-jpg', icon: FileImage },
        { name: 'JPG to PDF', description: 'Convert JPG images to a PDF file with our free tools.', href: '/tools/jpg-to-pdf', icon: FileDigit },
        { name: 'PDF Compressor', description: 'Reduce the file size of PDFs with our free tools.', href: '/tools/pdf-compressor', icon: FileSliders },
        { name: 'PDF Merger', description: 'Combine multiple PDFs into one with our free tools.', href: '/tools/pdf-merger', icon: Combine },
        { name: 'PDF Splitter', description: 'Split a PDF into multiple files with our free tools.', href: '/tools/pdf-splitter', icon: Layers },
        { name: 'PDF Password Remover', description: 'Remove password protection from a PDF with our free tools.', href: '/tools/pdf-password-remover', icon: FileKey2 },
        { name: 'PDF Page Rotator', description: 'Rotate pages in a PDF file with our free tools.', href: '/tools/pdf-page-rotator', icon: RotateCcw },
        { name: 'PDF to Word', description: 'Convert PDF files to Word documents with our free tools.', href: '/tools/pdf-to-word', icon: Book },
        { name: 'Word to PDF', description: 'Convert Word documents to PDF with our free tools.', href: '/tools/word-to-pdf', icon: FileText },
        { name: 'PDF Metadata Editor', description: 'Edit the metadata of a PDF file with our free tools.', href: '/tools/pdf-metadata-editor', icon: FileJson },
    ],
  },
  {
    ...
    icon: Code,
    tools: [
      { name: 'JSON Formatter & Validator', description: 'Format and validate JSON with our free tools.', href: '/tools/json-formatter', icon: Braces },
      { name: 'XML Formatter', description: 'Format and beautify XML code with our free tools.', href: '/tools/xml-formatter', icon: FileCode },
      { name: 'HTML Minifier', description: 'Minify HTML for performance with our free tools.', href: '/tools/html-minifier', icon: FileCode },
      { name: 'CSS Minifier', description: 'Minify CSS for performance with our free tools.', href: '/tools/css-minifier', icon: FileCode },
      { name: 'JavaScript Minifier', description: 'Minify JavaScript for performance with our free tools.', href: '/tools/javascript-minifier', icon: FileCode },
      { name: 'Base64 Encoder / Decoder', description: 'Encode and decode Base64 with our free tools.', href: '/tools/base64-encoder-decoder', icon: Shuffle },
      { name: 'URL Encoder / Decoder', description: 'Encode and decode URLs with our free tools.', href: '/tools/url-encoder-decoder', icon: Link2 },
      { name: 'UUID Generator', description: 'Generate unique identifiers with our free tools.', href: '/tools/uuid-generator', icon: Fingerprint },
      { name: 'Lorem Ipsum Generator', description: 'Generate placeholder text with our free tools.', href: '/tools/lorem-ipsum-generator', icon: MessageSquare },
      { name: 'Regex Tester', description: 'Test regular expressions with our free tools.', href: '/tools/regex-tester', icon: Regex },
    ],
  },
  {
    ...
    icon: Box,
    tools: [
      { name: 'QR Code Generator', description: 'Generate custom QR codes with our free tools.', href: '/tools/qr-code-generator', icon: QrCode },
      { name: 'Barcode Generator', description: 'Generate various barcode types with our free tools.', href: '/tools/barcode-generator', icon: Barcode },
      { name: 'Password Generator', description: 'Create strong, random passwords with our free tools.', href: '/tools/password-generator', icon: KeyRound },
      { name: 'Password Strength Checker', description: 'Check password strength with our free tools.', href: '/tools/password-strength-checker', icon: Shield },
      { name: 'Online Stopwatch', description: 'A simple online stopwatch, one of our many free tools.', href: '/tools/online-stopwatch', icon: Timer },
      { name: 'Countdown Timer', description: 'Set a countdown timer with our free tools.', href: '/tools/countdown-timer', icon: Hourglass },
      { name: 'Unit Converter', description: 'Convert various units of measurement with our free tools.', href: '/tools/unit-converter', icon: Scale },
      { name: 'Currency Converter', description: 'Convert between currencies with our free tools.', href: '/tools/currency-converter', icon: Landmark },
      { name: 'Time Zone Converter', description: 'Convert between time zones with our free tools.', href: '/tools/time-zone-converter', icon: Clock },
      { name: 'Age Calculator', description: 'Calculate age from a birth date with our free tools.', href: '/tools/age-calculator', icon: Cake },
    ],
  },
  {
    ...
    icon: GraduationCap,
    tools: [
      { name: 'GPA Calculator', description: 'Calculate your Grade Point Average with our free tools.', href: '/tools/gpa-calculator', icon: BookOpen },
      { name: 'Percentage Calculator', description: 'Calculate percentages easily with our free tools.', href: '/tools/percentage-calculator', icon: Percent },
      { name: 'Scientific Calculator', description: 'An online scientific calculator, one of our free tools.', href: '/tools/scientific-calculator', icon: FlaskConical },
      { name: 'Attendance Calculator', description: 'Calculate your attendance percentage with our free tools.', href: '/tools/attendance-calculator', icon: CalendarCheck },
      { name: 'Exam Timer', description: 'A timer for your exams and tests, one of our free tools.', href: '/tools/exam-timer', icon: Timer },
      { name: 'Notes Organizer', description: 'Organize your study notes with our free tools.', href: '/tools/notes-organizer', icon: Notebook },
      { name: 'Study Planner', description: 'Plan your study sessions with our free tools.', href: '/tools/study-planner', icon: ClipboardList },
      { name: 'Equation Solver', description: 'Solve mathematical equations with our free tools.', href: '/tools/equation-solver', icon: Sigma },
      { name: 'Prime Number Checker', description: 'Check if a number is prime with our free tools.', href: '/tools/prime-number-checker', icon: Sigma },
      { name: 'Math Formula Generator', description: 'Generate math formulas with our free tools.', href: '/tools/math-formula-generator', icon: FunctionSquare },
    ],
  },
  {
    ...
    icon: Briefcase,
    tools: [
      { name: 'EMI Calculator', description: 'Calculate Equated Monthly Installments with our free tools.', href: '/tools/emi-calculator', icon: Landmark },
      { name: 'Loan Calculator', description: 'Calculate loan payments with our free tools.', href: '/tools/loan-calculator', icon: Calculator },
      { name: 'Interest Calculator', description: 'Calculate simple and compound interest with our free tools.', href: '/tools/interest-calculator', icon: Banknote },
      { name: 'Profit Margin Calculator', description: 'Calculate profit margins with our free tools.', href: '/tools/profit-margin-calculator', icon: TrendingUp },
      { name: 'Invoice Generator', description: 'Create professional invoices with our free tools.', href: '/tools/invoice-generator', icon: Receipt },
      { name: 'GST / VAT Calculator', description: 'Calculate Goods & Services Tax with our free tools.', href: '/tools/gst-vat-calculator', icon: Percent },
      { name: 'Break-Even Calculator', description: 'Calculate your break-even point with our free tools.', href: '/tools/break-even-calculator', icon: CircleDollarSign },
      { name: 'Salary Calculator', description: 'Calculate your take-home salary with our free tools.', href: '/tools/salary-calculator', icon: Calculator },
      { name: 'Tax Estimator', description: 'Estimate your income tax with our free tools.', href: '/tools/tax-estimator', icon: Landmark },
      { name: 'Currency Profit Calculator', description: 'Calculate currency trading profits with our free tools.', href: '/tools/currency-profit-calculator', icon: Banknote },
    ],
  },
  {
    name: 'SEO & Web Tools',
    icon: Globe,
    tools: [
      { name: 'Meta Tag Generator', description: 'Generate meta tags for your site with our free tools.', href: '/tools/meta-tag-generator', icon: Tag },
      { name: 'Keyword Density Checker', description: 'Check keyword density of a text with our free tools.', href: '/tools/keyword-density-checker', icon: Search },
      { name: 'SEO Analyzer', description: 'Analyze your webpage for SEO with our free tools.', href: '/tools/seo-analyzer', icon: Search },
      { name: 'Page Speed Checker', description: 'Check your website\'s speed with our free tools.', href: '/tools/page-speed-checker', icon: Timer },
      { name: 'Sitemap Generator', description: 'Generate a sitemap.xml file with our free tools.', href: '/tools/sitemap-generator', icon: Network },
      { name: 'Robots.txt Generator', description: 'Generate a robots.txt file with our free tools.', href: '/tools/robots-txt-generator', icon: Route },
      { name: 'Open Graph Preview Tool', description: 'Preview Open Graph tags with our free tools.', href: '/tools/open-graph-preview', icon: Share2 },
      { name: 'Domain Age Checker', description: 'Check the age of a domain with our free tools.', href: '/tools/domain-age-checker', icon: Cake },
      { name: 'IP Address Lookup', description: 'Find the location of an IP with our free tools.', href: '/tools/ip-address-lookup', icon: Server },
      { name: 'HTTP Status Checker', description: 'Check HTTP status codes of URLs with our free tools.', href: '/tools/http-status-checker', icon: Fingerprint },
    ],
  },
  {
    ...
    icon: Palette,
    tools: [
      { name: 'Color Palette Generator', description: 'Generate color palettes with our free tools.', href: '/tools/color-palette-generator', icon: Palette },
      { name: 'Gradient Generator', description: 'Create CSS gradients with our free tools.', href: '/tools/gradient-generator', icon: Spline },
      { name: 'Font Pairing Tool', description: 'Find great font pairings with our free tools.', href: '/tools/font-pairing-tool', icon: Type },
      { name: 'Box Shadow Generator', description: 'Generate CSS box shadows with our free tools.', href: '/tools/box-shadow-generator', icon: AppWindow },
      { name: 'CSS Button Generator', description: 'Generate CSS for buttons with our free tools.', href: '/tools/css-button-generator', icon: AppWindow },
      { name: 'Border Radius Generator', description: 'Generate CSS for border radius with our free tools.', href: '/tools/border-radius-generator', icon: AppWindow },
    ],
  },
  {
    ...
    icon: ShieldCheck,
    tools: [
      { name: 'Hash Generator (MD5, SHA)', description: 'Generate hashes from text with our free tools.', href: '/tools/hash-generator', icon: Hash },
      { name: 'Hash Checker', description: 'Compare hashes to check integrity with our free tools.', href: '/tools/hash-checker', icon: BadgeCheck },
      { name: 'Random Username Generator', description: 'Generate random usernames with our free tools.', href: '/tools/random-username-generator', icon: User },
      { name: 'User Agent Checker', description: 'Check your browser\'s user agent with our free tools.', href: '/tools/user-agent-checker', icon: Binary },
    ],
  },
];
